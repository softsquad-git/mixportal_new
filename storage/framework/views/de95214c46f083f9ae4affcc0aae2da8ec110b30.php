<?php $__env->startSection('content'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 mb-3 ">
                ...
                <ui5-list id="listNews" style="height: 650px" infinite-scroll mode="SingleSelect">
                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <ui5-li type="details" onclick="details(<?php echo e($new); ?>)"  icon="nutrition-activity" image="<?php echo e($new->mainphoto['url'] ? 'images/adverts/'.$new->mainphoto['url'] : 'image/default-image.png'); ?>" description="<?php echo e($new->created_at); ?> Kategoria: <?php echo e($new->category['text']); ?>" info="Status: <?php if($new->payment['status'] == 'SUCCESS')echo 'Aktywne'; else echo '(czeka na aktywację)' ?>" info-state="info">
    ...
    <script type="text/javascript">
        ...
        function send(id){
            var url = '<?php echo e(route("advert", ':id')); ?>';
            url = url.replace(':id', 'id='+id);
            window.location.href=url;
        }
        function pay(type,id){
            var url = '<?php echo e(route("payment", ':type')); ?>';
        ...
        function routeto(data){
            var url = '<?php echo e(route("talent", ':slug')); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/mixportal/resources/views/advert/list.blade.php ENDPATH**/ ?>
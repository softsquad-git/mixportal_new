                    ...
                    <form method="get" action="" id="searchForm">
                        ...
                        <div class="row justify-content-start text-center header-customer mb-4">
                            ...
                            <div class="col-lg-3 mb-3 ">
                                <div>
                                    <input style="display: none;" type="text" value="<?php echo e($old['hiddenCity'] ?? ''); ?>"
                                    ...
                                    <input type="hidden" id="subcategory" name="subcategory"
                                           value="<?php echo e($old['subcategory'] ?? ''); ?>">
                                </div>
                                <input type="text" class="form-control" id="city" value="<?php echo e(old('city')); ?>"
                            ...
                            <div class="col-lg-1.5 ml-3">
                                <?php if( app('request')->input('type')  != 1000): ?><a class="btn btn-light"
                                                                               onclick="submitCategoryEvent()"
                                                                               href="javascript:{}">Szukaj</a><?php endif; ?>
                            </div>
                        </div>
                                        ...
                                        <li onclick="triggerChild(this)" class="col-md-3">
                                            <div class="icon-background col-md-12">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-12"><img class="img-fluid pt-2 pl-2 pb-2 pr-2"
                                                                                width="50px"
                                                                                src="image/icons/<?php echo e($cat->id); ?>.svg">
                                                    </div>
                                            ...
                                            <ul id="childContainer" class="child-container ">
                                                <div class="row justify-content-start">
                                                    <?php $__currentLoopData = $cat->category->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <a class="col-md-3 p-0 pl-2 "
                                                           onclick="submitCategory(<?php echo e($child->translates[0]->id); ?>)"
                                                           href="javascript:{}"><?php echo e($child->translates[0]->text); ?></a>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="city" onfocus="this.value=''"
                                               value="<?php echo e($old['city']); ?>" placeholder="Wpisz miejscowość"
                                                    ...
                                                    <div class="card-body">
                                                        <?php if($old['type'] != 1000): ?>
                                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input value="1" name="cat_<?php echo e($cat->id); ?>"
                                                                           type="checkbox"
                                                                           <?php if (isset($old['cat_' . $cat->id]) && $old['cat_' . $cat->id] == '1') echo 'checked'; ?> class="custom-control-input"
                                                                           id="customCheckDesktop<?php echo e($cat->id); ?>">
                                                                    <label class="custom-control-label"
                                                                           for="customCheckDesktop<?php echo e($cat->id); ?>"><?php echo e($cat->text); ?></label>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php else: ?>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <?php $__currentLoopData = $cat->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <a onclick="submitCategory(<?php echo e($child->id); ?>)"
                                                                               href="javascript:{}"><?php echo e($child->text); ?></a>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </ul>
                                                                </div>
                                                        ...
                                                        <?php if($old['type'] == 100): ?>
                                                            ...
                                                            <?php $__currentLoopData = $facility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input value="1" name="cat_<?php echo e($fac->id); ?>"
                                                                           type="checkbox"
                                                                           <?php if (isset($old['cat_' . $fac->id]) && $old['cat_' . $fac->id] == '1') echo 'checked'; ?> class="custom-control-input"
                                                                           id="customFacDesktop<?php echo e($fac->id); ?>">
                                                                    <label class="custom-control-label"
                                                                           for="customFacDesktop<?php echo e($fac->id); ?>"><?php echo e($fac->text); ?></label>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <?php if($old['type'] != 1000): ?>
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="custom-control custom-checkbox">
                                                    <input value="1" name="cat_<?php echo e($cat->id); ?>" type="checkbox"
                                                           <?php if (isset($old['cat_' . $cat->id]) && $old['cat_' . $cat->id] == '1') echo 'checked'; ?> class="custom-control-input"
                                                           id="customCheckDesktop<?php echo e($cat->id); ?>">
                                                    <label class="custom-control-label"
                                                           for="customCheckDesktop<?php echo e($cat->id); ?>"><?php echo e($cat->text); ?></label>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <?php $__currentLoopData = $cat->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><a onclick="submitCategory(<?php echo e($child->id); ?>)"
                                                                   href="javascript:{}"><?php echo e($child->text); ?></a></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                    ...
                                    <?php if($old['type'] == 100): ?>
                                        <div class="col-lg-12 mt-3">
                                            <?php $__currentLoopData = $facility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="custom-control custom-checkbox">
                                                    <input value="1" name="cat_<?php echo e($fac->id); ?>" type="checkbox"
                                                           <?php if (isset($old['cat_' . $fac->id]) && $old['cat_' . $fac->id] == '1') echo 'checked'; ?> class="custom-control-input"
                                                           id="customFacDesktop<?php echo e($fac->id); ?>">
                                                    <label class="custom-control-label"
                                                           for="customFacDesktop<?php echo e($fac->id); ?>"><?php echo e($fac->text); ?></label>
                ...
                <?php if($list): ?>
                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card mb-3 hoverEffect" style="min-height: 150px;">
                            ...
                            <a href="<?php echo e(route('talent',$l->slug)); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div style="min-height: 100px;" class="col-md-3 text-center align-content-center">
                                        <img style="max-width: 150px;"
                                             src="<?php echo e(!empty($l->allphotos[0]) ? 'images/adverts/'.$l->allphotos[0]->url : 'image/default-image.png'); ?>"
                                             class="img">
                                    </div>
                                    <div class="col-md-9">
                                        <div class="card-body">
